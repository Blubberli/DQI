...
class RobertaTwoTask(RobertaForSequenceClassification):
    def __init__(self, roberta_config_task1, roberta_config_task2):
...
@dataclass
class TwoTaskSequenceClassifierOutput(SequenceClassifierOutput):
    """
    Base class for outputs of sentence classification models.
    Args:
        loss (:obj:`torch.FloatTensor` of shape :obj:`(1,)`, `optional`, returned when :obj:`labels` is provided):
